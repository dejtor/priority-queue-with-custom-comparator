...
export class PriorityQueue<T> implements IPriorityQueue<T>{
    ...
    private siftDown() {
        ...
        while (
            ...
            let maxChild = (this.getRightChild(node) < this.size() && this.compareByIndex(this.getRightChild(node), this.getLeftChild(node))) ? this.getRightChild(node) : this.getLeftChild(node);
